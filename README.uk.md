...
**Як налаштувати.** **＋** біля розділу *ПРОЄКТИ* → виберіть теку кнопкою **…**
(системний діалог) або вставте шлях. Проєкт належить серверу, який зараз вибрано:
у проду свої теки, у стейджа свої; «усі сервери» робить його спільним.
